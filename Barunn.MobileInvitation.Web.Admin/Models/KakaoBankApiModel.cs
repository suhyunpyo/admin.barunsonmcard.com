...
namespace Barunn.MobileInvitation.Web.Admin.Models
{
    ...
    public class KP_BalanceCheck : KP_Firm
    {
        [JsonPropertyName("drw_bank_code")]
        public string DrwBankCode { set; get; }
    ...
    public class KP_BalanceCheckResult : KP_Result
    {
        [JsonPropertyName("natv_tr_no")]
        public string NatvTrNo { set; get; }
        [JsonPropertyName("request_at")]
        ...
        public long BalanceAmount { set; get; }
        [JsonPropertyName("payable_amount")]
        public long PayableAmount { set; get; }
    }
    #endregion
