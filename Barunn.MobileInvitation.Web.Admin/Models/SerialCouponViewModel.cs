...
namespace Barunn.MobileInvitation.Web.Admin.Models
{
    ...
    /// 쿠폰 검색 뷰 모델
    /// </summary>
    public class SerialCouponSearchViewModel : PageViewModel
    {
        /// <summary>
        /// 검색어
        /// </summary>
        ...
        /// 바인딩 아이템 목록
        /// </summary>
        public List<SerialCouponSearchDataModel> DataModel { set; get; }
    }

    /// <summary>
    /// 쿠폰 검색 데이터 모델
    /// </summary>
    public class SerialCouponSearchDataModel
    {
        /// <summary>
        /// 쿠폰 Id
        /// </summary>
    ...
    /// 쿠폰 등록/수정 뷰 모델
    /// </summary>
    public class SerialCouponEditModel
    {
        /// <summary>
        /// 쿠폰 Id
        /// </summary>
        ...
        /// CPTC03 엑셀업로드
        /// </summary>
        [Required(ErrorMessage = "쿠폰유형을 선택해주세요")]
        public string Coupon_Type_Code { get; set; }
        public IEnumerable<SelectListItem> Coupon_Type_Codes { get; set; }
        /// <summary>
        /// 쿠폰유형이 동일번호인 경우
        /// </summary>
    ...
    /// 쿠폰 상품 데이터 모델
    /// </summary>
    public class SerialCouponApplyProdcutListDataModel
    {
    ...
    /// 쿠폰 발행 검색 뷰 모델
    /// </summary>
    public class SerialCouponPublishSearchViewModel : PageViewModel
    {
        /// <summary>
        /// 쿠폰 Id
        /// </summary>
        ...
        /// 바인딩 아이템 목록
        /// </summary>
        public List<SerialCouponPublishSearchDataModel> DataModel { set; get; }
        public class SerialCouponPublishSearchDataModel
        {
    ...
    public class SerialCouponPublishAddViewModel
    {
        /// <summary>
        /// 쿠폰 Id
        /// </summary>
        ...
        /// 바인딩 아이템 목록
        /// </summary>
        public List<SerialCouponPublishAddDataModel> DataModel { set; get; }
        public class SerialCouponPublishAddDataModel
        {
            /// <summary>
            /// Id
            /// </summary>
    ...
    public class SerialCouponPublishAddSaveViewModel
    {
        /// <summary>
        /// 쿠폰 Id
        /// </summary>
