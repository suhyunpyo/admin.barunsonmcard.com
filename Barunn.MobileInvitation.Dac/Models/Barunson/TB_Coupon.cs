...
namespace Barunn.MobileInvitation.Dac.Models.Barunson
{
    public partial class TB_Coupon
    {
        public TB_Coupon()
        {
            TB_Coupon_Publish_TESTs = new HashSet<TB_Coupon_Publish_TEST>();
            TB_Coupon_Publishes = new HashSet<TB_Coupon_Publish>();
        }
        ...
        public virtual ICollection<TB_Coupon_Publish_TEST> TB_Coupon_Publish_TESTs { get; set; }
        public virtual ICollection<TB_Coupon_Publish> TB_Coupon_Publishes { get; set; }
    }
}
