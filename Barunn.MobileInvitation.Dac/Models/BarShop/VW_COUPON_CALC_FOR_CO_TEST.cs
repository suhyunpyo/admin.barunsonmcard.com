...
{
    public partial class VW_COUPON_CALC_FOR_CO_TEST
    {
        ...
        public int DISCOUNT_TARGET_FLOWER_PRICE { get; set; }
        public int DISCOUNT_TARGET_SEALING_PRICE { get; set; }
        public int DISCOUNT_TARGET_ENVSPECIAL_PRICE { get; set; }
        public int DISCOUNT_TARGET_RIBBON_PRICE { get; set; }
        public int DISCOUNT_TARGET_PAPERCOVER_PRICE { get; set; }
        ...
        public decimal DISCOUNT_FLOWER_PRICE { get; set; }
        public decimal DISCOUNT_SEALING_STICKER_PRICE { get; set; }
        public decimal DISCOUNT_ENVSPECIAL_PRICE { get; set; }
        public decimal DISCOUNT_RIBBON_PRICE { get; set; }
        public decimal DISCOUNT_PAPERCOVER_PRICE { get; set; }
